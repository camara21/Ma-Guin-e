...
class _CGUBottomSheetState extends State<CGUBottomSheet> {
  ...
  String get _fullCguText {
    ...
    return '🧾 CONDITIONS GÉNÉRALES D’UTILISATION (CGU)\n\n'
        ...
        'Éditeur / Responsable de publication : Soneya (projet). Contact : soneya.signaler@gmail.com.\n\n'
        ...
        'Soneya peut suspendre temporairement l’accès au service pour maintenance, mise à jour ou raison de sécurité, sans indemnisation.\n\n'
        ...
        '7. Âge requis et protection des mineurs\n\n'
        ...
        '17. Contact\n\n'
        '📧 E-mail : soneya.signaler@gmail.com\n'
